...
file_path = "/workspaces/SC_model_1st/main_code/20240322_Supercon_data_allstr_handedited.csv"
check_words = ["pressure", "gpa", "mbar"]
export_file_path = "/workspaces/SC_model_1st/main_code/final_SC_X_data.csv"
